...
# I do now the same version of the task but I remove the time horizon bar, and I change the colour of the square which will appear around the selected toy
...
def load_conditions():
    ...
    if sys.platform.startswith('macOS'):  # are these the right info?
        file_path = {'condition': r'..O:\bandit_task\bandit_task\STUDENT_BabyBandit\condition.xlsx'}  #CHANGE FILE_PATH IF YOU CHANGE COMPUTER/LOCATION
